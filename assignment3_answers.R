...
rmp_test$sentiment_VD<-vader_df(rmp_test$comments)$compound

rmp_test$sentiment_SR<-sentiment_by(rmp_test$comments)$ave_sentiment
...
rmp_test$sentiment_NRC<-rmp_test_dicts$NRC_sentiment

kendall_acc(rmp_test$student_star,rmp_test$sentiment_NRC)
kendall_acc(rmp_test$student_star,rmp_test$sentiment_VD)
kendall_acc(rmp_test$student_star,rmp_test$sentiment_SR)
